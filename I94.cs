...
public partial class HDevelopExport
{
  ...
  private void action()
  {
    ...
    HObject ho_Image=null, ho_ImageUndistorted=null;
    HObject ho_lineRegions=null, ho_FindLineRects=null, ho_Cross4=null;

    // Local control variables 

    HTuple hv_ModelID = null, hv_imageDir = null;
    HTuple hv_Width = null, hv_Height = null, hv_FileHandle = null;
    HTuple hv_header = null, hv_FAI_NAMES = null, hv_AcqHandle = null;
    HTuple hv_Biases = null, hv_Thresholds = null, hv_WindowHandle = null;
    HTuple hv_Index = null, hv_outputs = new HTuple(), hv_crossesXUsed = new HTuple();
    HTuple hv_crossesYUsed = new HTuple(), hv_crossesXIgnored = new HTuple();
    HTuple hv_crossesYIgnored = new HTuple(), hv_intersectXs = new HTuple();
    HTuple hv_intersectYs = new HTuple(), hv_outputsPixel = new HTuple();
    HTuple hv_crossSize = new HTuple(), hv_mod = new HTuple();
    ...
    try
    {
      HOperatorSet.ReadShapeModel("C:/Users/afterbunny/Documents/Projects/Hdevs/ModelTopViewI94", 
          out hv_ModelID);
      hv_imageDir = "C:/Users/afterbunny/Pictures/Images/I94/shang/动态/2/MV-CH250-20TM-F-NF (00D46076741)/";
      ...
      hv_header = new HTuple("2_2,3_2,4_1,4_2,4_3,5_1,5_2,5_3,6_1,6_2,6_3,9_1,9_2,9_3,12_1,12_2,16_1,16_2,17_1,17_2,19_1,19_2,20_1,20_2");
      hv_FAI_NAMES = new HTuple();
      hv_FAI_NAMES[0] = "FAI2-P2";
      hv_FAI_NAMES[1] = "FAI3-P2";
      hv_FAI_NAMES[2] = "FAI4-P1";
      hv_FAI_NAMES[3] = "FAI4-P2";
      hv_FAI_NAMES[4] = "FAI4-P3";
      hv_FAI_NAMES[5] = "FAI5-P1";
      hv_FAI_NAMES[6] = "FAI5-P2";
      hv_FAI_NAMES[7] = "FAI5-P3";
      hv_FAI_NAMES[8] = "FAI6-P1";
      hv_FAI_NAMES[9] = "FAI6-P2";
      hv_FAI_NAMES[10] = "FAI6-P3";
      hv_FAI_NAMES[11] = "FAI9-P1";
      hv_FAI_NAMES[12] = "FAI9-P2";
      hv_FAI_NAMES[13] = "FAI9-P3";
      hv_FAI_NAMES[14] = "FAI12-P1";
      hv_FAI_NAMES[15] = "FAI12-P2";
      hv_FAI_NAMES[16] = "FAI16-P1";
      hv_FAI_NAMES[17] = "FAI16-P2";
      hv_FAI_NAMES[18] = "FAI17-P1";
      hv_FAI_NAMES[19] = "FAI17-P2";
      hv_FAI_NAMES[20] = "FAI19-P1";
      hv_FAI_NAMES[21] = "FAI19-P2";
      hv_FAI_NAMES[22] = "FAI20-P1";
      hv_FAI_NAMES[23] = "FAI20-P2";
      ...
      HOperatorSet.OpenFramegrabber("File", 1, 1, hv_Width, hv_Height, 0, 0, "default", 
          -1, "default", -1, "false", hv_imageDir+"images.seq", "", 1, 2, out hv_AcqHandle);


      hv_Biases = new HTuple();
      hv_Biases[0] = 0;
      hv_Biases[1] = 0;
      hv_Biases[2] = 0;
      hv_Biases[3] = 0;
      ...
      HOperatorSet.OpenWindow(0,0,800,800,0,"visible","",out hv_WindowHandle);
      ...
      for (hv_Index=1; (int)hv_Index<=9; hv_Index = (int)hv_Index + 1)
      {
        ...
        ho_ImageUndistorted.Dispose();ho_lineRegions.Dispose();ho_FindLineRects.Dispose();
        I94TopFaceMeasurement(ho_Image, out ho_ImageUndistorted, out ho_lineRegions, 
            out ho_FindLineRects, hv_ModelID, 0.0076, 0.0076, hv_Thresholds, out hv_outputs, 
            out hv_crossesXUsed, out hv_crossesYUsed, out hv_crossesXIgnored, out hv_crossesYIgnored, 
            out hv_intersectXs, out hv_intersectYs, out hv_outputsPixel);
        ...
        if (HDevWindowStack.IsOpen())
        {
          HOperatorSet.DispObj(ho_ImageUndistorted, HDevWindowStack.GetActive());
        }
        if (HDevWindowStack.IsOpen())
        {
          HOperatorSet.SetColor(HDevWindowStack.GetActive(), "red");
        ...
        hv_crossSize = 100;
        ho_Cross4.Dispose();
        HOperatorSet.GenCrossContourXld(out ho_Cross4, hv_crossesYIgnored, hv_crossesXIgnored, 
        ...
        ho_Cross4.Dispose();
        HOperatorSet.GenCrossContourXld(out ho_Cross4, hv_crossesYUsed, hv_crossesXUsed, 
            hv_crossSize, 0.785398);
        if (HDevWindowStack.IsOpen())
        {
        ...
        ho_Cross4.Dispose();
        HOperatorSet.GenCrossContourXld(out ho_Cross4, hv_intersectYs, hv_intersectXs, 
            200, 0);
        if (HDevWindowStack.IsOpen())
        {
        ...
        if (HDevWindowStack.IsOpen())
        {
          HOperatorSet.DispObj(ho_lineRegions, HDevWindowStack.GetActive());
        }
        if (HDevWindowStack.IsOpen())
        {
        ...
        if (HDevWindowStack.IsOpen())
        {
          HOperatorSet.DispObj(ho_FindLineRects, HDevWindowStack.GetActive());
        }
        ...
        for (hv_Index1=0; (int)hv_Index1<=(int)((new HTuple(hv_outputsPixel.TupleLength()
            ))-1); hv_Index1 = (int)hv_Index1 + 1)
        {

          if ((int)(new HTuple(hv_Index1.TupleEqual((new HTuple(hv_outputsPixel.TupleLength()
              ))-1))) != 0)
          {

            HOperatorSet.FwriteString(hv_FileHandle, ((hv_outputsPixel.TupleSelect(
                hv_Index1))+new HTuple(","))+hv_mod);
          }
          else
          {
            HOperatorSet.FwriteString(hv_FileHandle, (hv_outputsPixel.TupleSelect(
